...
object DauApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    realFilteredDStream.foreachRDD{rdd=>
     ...
     // redis   1 数据类型是什么  string 好分片   set 好管理 选用  2 key  dau:2019-08-13  3 value  mid
      rdd.foreachPartition{ startuplogItr=>
        val jedis: Jedis = new Jedis("hadoop102", 6379) //executor
    ...
    realFilteredDStream.foreachRDD{rdd=>
      ...
      rdd.saveToPhoenix("gmall0311_dau1",Seq("MID", "UID", "APPID", "AREA", "OS", "CH", "TYPE", "VS", "LOGDATE", "LOGHOUR", "TS"),
        new Configuration,Some("hadoop102:2181"))
